...
// NOTE: Similar solution for React with react-router

// import { useEffect } from 'react';
// import { useLocation } from 'react-router-dom';
//
// export function AccessibleRouterHelper(): void {
...
//   }
//
//   function setFocusOnFirstHeading(): void {
//     setTimeout(() => {
//       const heading: HTMLHeadingElement | null = document.querySelector('main h1');
//
//       if (!heading) {
//         return;
//       }
